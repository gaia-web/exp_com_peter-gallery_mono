...
export function HomePage() {
  ...
  return (
    <div>
      <div class="threePics bottom-10 right-10 mb-2rem br-2rem ">
      ...
      <div class="scaleDown h-85vh text-center slogan">
        <div class="m-auto h-6rem relative flex justify-center items-end text-7xl">
          那颗我们所钟爱的
        </div>
        <div class=" m-auto pt-0.5rem h-6rem text-7xl">
          蔚蓝星球
        </div>
        <div class="line bg-#0042ED m-auto h-0.2rem rounded-full ">
        </div>
        <div class="pt-2rem text-2xl">
          以及，在她之上生生不息的我们
        </div>
      </div>
    </div>
